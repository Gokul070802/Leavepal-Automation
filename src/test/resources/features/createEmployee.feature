...
#     When Navigate to the employee details section
#     And Click on the Add Employee button
#     And Fill in the employee details with role 'employee', email 'spiderman@leavepal.com', password 'Employee@123', firstName 'Peter', lastName 'Parker', department 'Engineering', designation 'Developer', reportingManager 'Chota Bheem (LP-006)', location 'Chennai' and dateOfJoining '19-04-2026'
#     And Click on the Save button
